        ...
        <div style="margin-bottom: 30px">
            <el-row>
                <el-text v-show="list.length === 0"
                    >Currently there're no defined projects.&nbsp;</el-text
                >
        ...
        <div
            ...
            <el-descriptions
                ...
                <el-descriptions-item
                    ...
                    label="Script"
                    >{{ element.script }}</el-descriptions-item
                >
                <el-descriptions-item
                    v-if="element.port !== null"
                    label="Port"
                    >{{ element.port }}</el-descriptions-item
                >
                <el-descriptions-item
                    v-if="element.args !== null"
                    label="Args"
                    :span="3"
                    >{{ element.args }}</el-descriptions-item
                >
            </el-descriptions>
        </div>
    </div>
