        ...
        <el-page-header @back="back" style="margin-bottom: 20px">
            <template #content>
                <span class="text-large font-600 mr-3">
                    Explore RESTful APIs of {{ model.name }} in the database
                    {{ model.dbName }}
                </span>
            </template>
        </el-page-header>
            ...
            <el-collapse>
                ...
                <el-collapse-item title="Advanced query">
                    ...
                    <p>
                        ...
                        specifying the filter (where), offset, limit and the
                        order.
                    </p>
                    <p>
                    ...
                    <p>
                        For the property "offset" and "limit", simply specify
                        with an integer for the result pagenation.
                    </p>
                    <p>
...
const advancedQueryExample = ref(
    JSON.stringify(
        {
            where: {
                '$and': [
